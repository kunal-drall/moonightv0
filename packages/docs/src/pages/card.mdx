...
> This feature is under research and will be available after mainnet launch.
...
Credit limits would be algorithmically determined from on-chain activity, enabling under-collateralized borrowing for users with established protocol history.
